-- I switched to starting with kickstart instead of my previous setup
...
require('lazy').setup({
  ...
  --  LSP configuration is done below. Search for lspconfig to find it below.
  {
...
vim.diagnostic.config({virtual_text = false, highlight = false})
-- vim.api.nvim_command('highlight DiagnosticUnderline none');
